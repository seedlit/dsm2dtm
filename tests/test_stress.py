...
def test_sparse_ground_points():
    ...
    # With 1000x1000 pixels (assuming 1m res), 40m radius might be small for massive buildings
    # if ground points are super sparse. But 5% random distribution usually has points everywhere.
